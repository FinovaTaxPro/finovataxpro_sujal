    ...
    if (typeof window !== 'undefined') {
      ...
      if (existingCart) {
        try {
          ...
          if (Array.isArray(items)) {
            items = items.filter(item => item && item.slug && item.price !== undefined)
          } else {
            items = []
          }
        } catch (e) {
      ...
      if (pendingService) {
        try {
          ...
          // Check if the pending service has the correct structure
          if (service && service.slug && service.price !== undefined) {
            ...
            // Invalid pending service, just clear it
            localStorage.removeItem('pendingService')
          }
        } catch (e) {
