...
export default function Header() {
  ...
  const handleOurTeamClick = (e: React.MouseEvent) => {
    e.preventDefault();
    setMobileOpen(false);
    if (pathname === '/') {
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden xl:flex items-center space-x-1 xl:space-x-2">
            ...
            <a
              ...
              className="px-2 xl:px-3 py-2 text-cyan-300 bg-cyan-500/10 border border-cyan-500/40 hover:bg-cyan-500/25 hover:text-cyan-200 hover:border-cyan-400/70 hover:shadow-lg hover:shadow-cyan-500/30 transition-all duration-300 text-xs xl:text-sm font-medium rounded-lg whitespace-nowrap"
            >
              Our Team
            </a>
            ...
            <a
              href="/#cta-section"
              className="px-2 xl:px-3 py-2 text-white bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 hover:shadow-lg hover:shadow-cyan-500/40 transition-all duration-300 text-xs xl:text-sm font-semibold rounded-lg whitespace-nowrap"
            >
              Contact
            </a>
          </nav>
        ...
        <div className="xl:hidden border-t border-cyan-500/30 bg-gradient-to-br from-slate-900/95 via-blue-900/95 to-slate-800/95 backdrop-blur-lg max-h-[80vh] overflow-y-auto">
          <div className="px-4 py-4 space-y-2">
            ...
            <a
              href="/#our-team"
              onClick={handleOurTeamClick}
              className="block px-3 py-2 rounded-md text-cyan-300 bg-cyan-500/10 border border-cyan-500/40 hover:bg-cyan-500/25 hover:text-cyan-200 hover:border-cyan-400/70 transition-all duration-300 font-medium"
            >
              Our Team
            </a>
            ...
            <a
              href="/#cta-section"
              className="block px-3 py-2 rounded-md text-white bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 transition-all duration-300 font-semibold"
              onClick={() => setMobileOpen(false)}
            >
              Contact
            </a>
